...
static const char *fonts[]          = { "monospace:size=7", "JoyPixels:pixelsize=7:antialias=true:autohint=true"  };
...
static char selbgcolor[]            = "#aa0000"; /* #005577 = ori color */
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_minus,	spawn,		SHCMD("amixer sset Master 10%-") },
